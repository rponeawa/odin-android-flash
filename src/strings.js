const ZH = {
  ...
  resume: "继续",
  skip: "跳过",
  mockMode: "Mock 模式（仅供测试，真实刷机请勿启用）",
  waiting: "等待操作",
  ...
  collectorFailed: "采集程序没有跑起来：{text}",
...
const EN = {
  ...
  resume: "Resume",
  skip: "Skip",
  mockMode: "Mock mode (testing only, do not enable for a real flash)",
  waiting: "Idle",
  ...
  collectorFailed: "The collector did not run: {text}",
