...
const url=process.env.MEGA_FOLDER_URL, start=Number(process.env.RANGE_START), end=Number(process.env.RANGE_END), out=process.env.OUTPUT;
...
console.log(JSON.stringify({name:decodeURIComponent(file.name),size:file.size,start,end}));
